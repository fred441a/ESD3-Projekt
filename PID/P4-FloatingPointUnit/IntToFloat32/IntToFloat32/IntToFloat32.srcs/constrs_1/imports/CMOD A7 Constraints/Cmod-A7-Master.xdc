...
#set_property -dict { PACKAGE_PIN R2    IOSTA8NDARD LVCMOS33 } [get_ports { pio28 }]; #IO_L1P_T0_34 Sch=pio[28]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets RW_IBUF[0]]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets RW_IBUF[1]]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ExtMCUCLK_IBUF]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets {ExtSYSCLK_IBUF}]

set_property IOSTANDARD LVTTL [get_ports {ExtAddr[4]}]
set_property IOSTANDARD LVTTL [get_ports {ExtAddr[3]}]
set_property IOSTANDARD LVTTL [get_ports {ExtAddr[2]}]
set_property IOSTANDARD LVTTL [get_ports {ExtAddr[1]}]
set_property IOSTANDARD LVTTL [get_ports {ExtAddr[0]}]
...
set_property IOSTANDARD LVTTL [get_ports ExtMCUCLK]
set_property IOSTANDARD LVTTL [get_ports ExtRW]
set_property IOSTANDARD LVTTL [get_ports ExtSYSCLK]
...
set_property PACKAGE_PIN V3 [get_ports ExtMCUCLK]
set_property PACKAGE_PIN W5 [get_ports ExtRW]
set_property PACKAGE_PIN V4 [get_ports ExtSYSCLK]
set_property PACKAGE_PIN P1 [get_ports {ExtAddr[4]}]
set_property PACKAGE_PIN N2 [get_ports {ExtAddr[3]}]
set_property PACKAGE_PIN N1 [get_ports {ExtAddr[2]}]
set_property PACKAGE_PIN M2 [get_ports {ExtAddr[1]}]
set_property PACKAGE_PIN P3 [get_ports {ExtAddr[0]}]

set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[7]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[6]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[5]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[4]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[3]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[2]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[1]}]
set_property IOSTANDARD LVTTL [get_ports {I_DataReg9[0]}]
set_property PACKAGE_PIN M3 [get_ports {I_DataReg9[7]}]
set_property PACKAGE_PIN L3 [get_ports {I_DataReg9[6]}]
set_property PACKAGE_PIN A16 [get_ports {I_DataReg9[5]}]
set_property PACKAGE_PIN K3 [get_ports {I_DataReg9[4]}]
set_property PACKAGE_PIN C15 [get_ports {I_DataReg9[3]}]
set_property PACKAGE_PIN H1 [get_ports {I_DataReg9[2]}]
set_property PACKAGE_PIN A15 [get_ports {I_DataReg9[1]}]
set_property PACKAGE_PIN B15 [get_ports {I_DataReg9[0]}]
